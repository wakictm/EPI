...
public class SecondaryController implements Initializable{
    ...
    private void graficar(ActionEvent event) {
        ...
        if(contElectrolisis == 0){
            ...
            nombre = "Electrolisis alcalina";
            
        }
        
        else{ 
        
            nombre = "Electrolisis PEM";
        }
        
        
        ParametrosSimulados p1 = new ParametrosSimulados(corriente, voltaje, tiempo, eficiencia, temperatura, presion, nombre);
...
public void initialize(URL url, ResourceBundle rb) {
    ...
    private void preBaja(ActionEvent event) {
        ...
        double presion = 1;
        String nombre = "Electrolisis alcalina";
        ParametrosSimulados p1 = new ParametrosSimulados(corriente, voltaje, tiempo, eficiencia, temperatura, presion, nombre);
        ...
        double presion = 1;
        String nombre = "Electrolisis PEM";
