...
public class TertiaryController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        for (int i = 0; i < r2.getResultados().size(); i++) {
            ...
            areaChart.setTitle("Volumen de H2 - Resultado " + (i + 1));
            ...
            panelResultados.setStyle("-fx-padding: 10; -fx-background-color:#f4f4f4;"
                    +  "-fx-background-radius: 8; -fx-border-color: #cccccc;");
            panelResultados.setPrefWidth(250);
            panelResultados.setPrefHeight(100);
            ...
            txtKgH2.setText(String.format("%.6f", kgH2));
            txtCO2.setText(String.format("%.2f", co2));
            ...
            panelResultados.getChildren().addAll(
                ...
                new HBox(new Label("Energía:"), txtEnergia)
            );
