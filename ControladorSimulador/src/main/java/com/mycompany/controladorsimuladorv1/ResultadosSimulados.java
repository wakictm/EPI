...
public class ResultadosSimulados {
    ...
    public double simularResultados(int indice, double tiempo){
        ...
        energiaConsumida = (resultados.get(indice).getCorriente()* resultados.get(indice).getVoltaje()*resultados.get(indice).getTiempoElectrolisis())/3600;
        
        Kgh2 = (moles *  0.002016);
        
        co2Evitado = Kgh2 * 10;
        
        eficienciaEnergetica = ((moles * 237000)/ (energiaConsumida*3600))*100;
